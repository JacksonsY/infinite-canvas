...
export const defaultConfig: AiConfig = {
    ...
    channels: [
        {
            ...
            models: [
                ...
                { name: "doubao-seedance-2.0-mini", capability: "video" },
    ...
    videoModel: "default::doubao-seedance-2.0-mini",
            ...
            merge: (persisted, current) => {
                ...
                return {
                    ...
                    config: {
                        ...
                        videoModel: normalizeModelOptionValue(config.videoModel || "doubao-seedance-2.0-mini", channels),
